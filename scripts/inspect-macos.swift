...
if CommandLine.arguments.contains("--verify") {failed = failed || webAreas < 2 || !running;print(failed ? "FAIL: native readiness/authentication" : "PASS: native readiness/authentication");exit(failed ? 1 : 0)}
